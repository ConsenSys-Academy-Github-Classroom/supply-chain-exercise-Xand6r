...
contract SupplyChain {
  ...
  function buyItem(uint sku) forSale(sku)  paidEnough(sku) checkValue(sku) public payable {
  ...
  function shipItem(uint sku) sold(sku) public {
    require(msg.sender == items[sku].seller, "not seller");
  ...
  function receiveItem(uint sku) shipped(sku) public {
    require(msg.sender == items[sku].buyer, "not buyer");
